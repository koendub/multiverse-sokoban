/**
 * Plain binary min-heap, ordered by an externally-supplied numeric
 * priority (lower first) - used by solveLevel.ts for A*'s open set, where
 * `priority` is a state's f = g + h.
 */
